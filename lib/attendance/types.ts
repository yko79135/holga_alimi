export type AttendanceStatus = "present" | "late" | "absent" | "early_leave" | "sick_leave";
export type AttendanceExceptionStatus = Exclude<AttendanceStatus, "present">;

export const ATTENDANCE_STATUSES: AttendanceStatus[] = ["present", "late", "absent", "early_leave", "sick_leave"];
export const ATTENDANCE_EXCEPTION_STATUSES: AttendanceExceptionStatus[] = ["late", "absent", "early_leave", "sick_leave"];
...
export function emptyExceptionCounts(): Record<AttendanceExceptionStatus, number> {
  return { late: 0, absent: 0, early_leave: 0, sick_leave: 0 };
}
