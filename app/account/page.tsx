...
export default async function AccountPage(){
  ...
  return <main className="app-shell"><Header name={p?.full_name||user.email||"사용자"} roles={roles} activeView={activeView} currentPage="account"/><AccountSettings email={user.email||""} roles={roles}/></main>;
}
