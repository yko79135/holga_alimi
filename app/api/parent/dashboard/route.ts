...
export async function GET() {
  ...
  return NextResponse.json({ students: studentRows, notices, warnings: warnings || [], attendance: attendance || [], praise: praise || [] });
}
