...
export async function GET() {
  ...
  const [{ data: school }, { data: grade }, { data: individual }, { data: warnings }, { data: attendance }] = await Promise.all([
  ...
  return NextResponse.json({ students: studentRows, notices, warnings: warnings || [], attendance: attendance || [] });
}
